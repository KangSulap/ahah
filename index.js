...
`;
        sendButImage(from, menu, "by @DpinBot ❤️", thumb, [
          {
...
case 'fftext': 				
				...
				syaa.sendMessage(from, dapuhy, image, { quoted: mek, caption: 'Nih Jangan Lupa Follow Ig @_dvnrnngg.id' })
				break
case 'kbbi':	
...
case "report":
                    ...
                    syaa.sendMessage('6283146208804@s.whatsapp.net', options, text, {quoted: mek})
...
break
                    ...
                    syaa.sendMessage(from, buffer, image, {caption: 'Nih kak.. *Jangan lupa follow ig @_dvnrngg.id', quoted: mek})
                break
case "attp":
  if (isBanned) return reply(mess.ban)
...
encmediam = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
				...
				break
case "bahasa"://FIXED BY herman
case "kodebahasa"://FIXED BY herman
case "code"://FIXED BY herman
if (isBanned) return reply(mess.ban)
...
case 'donat':
  ...
  ├─ ❏ 085694882557
  ├─ ❏ *INSTAGRAM*
  └─ ❏ https://www.instagram.com/@_dvnrngg.id`)
...
• ${prefix}fitnah
• ${prefix}fitnahpc
• ${prefix}kontak 6285694982557|Dpin
• ${prefix}jadian
• ${prefix}
• ${prefix}tod
• ${prefix}truth
...
case "peraturan2":
					// Fix Case by Arasyaaa
					sya = await getBuffer(`https://telegra.ph/file/13896c1fd5ab299da90b7.jpg`)
					syaa.sendMessage(from, sya, image, { quoted: mek, caption: `Dpin bot merupakan suatu program bot whatsapp, yang menggunakan engine nodejs v14.x.x
Adapun ketentuan untuk memakai Dpin bot. :
...
case "naruto2":
				...
				if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix + command} Dpin Ganteng`)
				reply('Bentar lagi di proses')
...
case "pubglogo":
				...
				if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix}pubglogo Dpin|Ganz`)
...
case 'tiktokvid':
    ...
    Follower: ${i.result.stats.followerCount}`;
     ...
     /* case "waifu":
      ...
      case "aeshtetic":
      case "wallpaperanime":
        sendButMessage(from, `Random Image by @Herman botz`, `press the button below`, [
          {
        ...
        break
case "bis":
  sendButMessage(from, `Random Image by @herman`, `press the button below`, [
          {
...
- *Link Dev* : ${i.link_dev}\n❉─────────────────────❉`;
      ...
      case "colong":
        ...
        dua = typeof anu[1] !== "undefined" ? anu[1] : `@herman`;
